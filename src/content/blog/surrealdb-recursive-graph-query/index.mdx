...
---
import { calloutIcons } from '$components/icons';
...
<Markdown title="Dockerfile example" variant="note" category="dockerfile" name="golang" />
a
<Callout variant="note" message="This is a simple Dockerfile for a Golang application." />
b
<Callout variant="warning" message="This is a simple Dockerfile for a Golang application." />
c
<Callout variant="info" message="This is a simple Dockerfile for a Golang application." />
<Callout variant="error" message="This is a simple Dockerfile for a Golang application." />
<Callout variant="success" message="This is a simple Dockerfile for a Golang application." />
<Callout variant="tip" message="This is a simple Dockerfile for a Golang application." />
...
```
### asdf asd f asd fa sdf a sf a sd
asdfas
